...
#NECESITAS UNA PANTALLA INCIAL EXPLICANDO EL OBJETIVO DEL JUEGO, CON UN BOTON PARA COMENZAR EL JUEGO
#AL PERDER, NECESITAS UNA PANTALLA QUE DIGA GAME OVER Y UN BOTON PARA VOLVER A JUGAR
#jugador
jugador_size = 50
